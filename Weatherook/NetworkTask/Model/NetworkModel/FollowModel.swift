...
class FollowModel: Codable {
    ...
    init(message: String?, data: [Datum4]?) {
        self.message = message
        self.data = data
    }
}

class Datum4: Codable {
    let boardIdx: Int?
    ...
    init(boardIdx: Int?, userImg: String?, userID: String?, boardImg: String?, boardDesc: String?, likeCnt: Int?, likeFlag: Int?, boardTempMin: Int?, boardTempMax: Int?, boardWeather: Int?, boardDate: String?, commentList: [CommentList4]?, commentCnt: Int?, flag: Int?) {
